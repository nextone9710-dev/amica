...
export default function AboutUs() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Banner */}
      <section
        className="relative pt-28 pb-10 lg:pb-20 overflow-hidden"
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 50% at 70% 50%, rgba(227,30,36,0.08) 0%, transparent 70%)",
          }}
        />
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                {stats.map((stat) => (
                  <div key={stat.label}>
                    ...
                    <p className="text-white/40 text-xs tracking-wide uppercase mt-1">
                      {stat.label}
                    </p>
                  </div>
                ))}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-4">
                  <LazyImage
                    ...
                    wrapperClassName="rounded-2xl overflow-hidden h-48"
                  />
                  <LazyImage
                    src={nurseImg}
                    alt="Healthcare uniforms"
                    className="w-full h-full object-cover"
                    wrapperClassName="rounded-2xl overflow-hidden h-56"
                  />
                </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                <span className="font-semibold text-gray-900">
                  Statement from the People Director:
                </span>{" "}
                {companyInfo.name} Ltd takes its responsibilities under the
                Modern Slavery Act 2015 extremely seriously. This statement
                outlines our commitment to identifying, understanding, and
                addressing potential modern slavery risks across our operations
                and <strong>bulk uniform production</strong> supply chain.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                At {companyInfo.name}, we are dedicated to ensuring that all
                workers involved in our business and supply chain are treated
                fairly, with dignity, and in safe working conditions. To achieve
                this:
              </p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  Our senior management team is accountable for enforcing these
                  standards within their departments and for maintaining
                  supplier relationships that reflect {companyInfo.name}'s
                  commitment to ethical practices. By taking these steps, we aim
                  to build a transparent, responsible, and sustainable business
                  ecosystem that respects people, communities, and the
                  environment.
                </p>
              </div>
            </div>
