...
const isoAlignment = [
  {
    ...
    description:
      "Rigorous 7-stage inspection protocol ensures every garment meets exact specifications.",
  },
  {
    icon: (
      <svg
    ...
    title: "Traceability",
    description:
      "Full documentation trail from raw material sourcing to final shipment delivery.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Regular internal and third-party audits to maintain compliance and improve processes.",
  },
];
            ...
            <div>
              ...
              <div className="border-l-4 border-primary pl-6 mb-8">
                <p className="text-gray-600 text-lg leading-relaxed">
                  Quality and ethics define {companyInfo.name} Pvt Ltd. From
                  fabric sourcing to final{" "}
                  <strong>door-to-door delivery</strong>, we ensure every{" "}
                  <strong>custom uniform</strong> meets the highest professional
                  standards. "Delivering trust, reliability, and consistent
                  quality is at the heart of everything we do." Whether
                  supplying national brands, schools, hospitals, or local
                  businesses, our goal is to build long-term partnerships based
                  on reliability and service excellence.
                </p>
              </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
            Experience the difference that certified quality and ethical
            manufacturing can make for your brand.
          </p>
