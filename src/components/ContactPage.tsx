          ...
          <div className="grid lg:grid-cols-5 gap-12 items-stretch">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-wide mb-4">
                ...
                <span className="text-primary">uniform solutions</span>
              </h2>
              <div className="w-16 h-1 bg-primary mb-6" />
              <p className="text-gray-600 leading-relaxed mb-6">
                Fill in the form and our team will get back to you. You can
                write details about your <strong>bulk uniform</strong> order or
            ...
            <div className="lg:col-span-3 flex flex-col">
              <div className="bg-gray-50 rounded-2xl p-8 md:p-10 border border-gray-100 flex flex-col flex-1">
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1">
                      ...
                      <textarea
                        ...
                        required
                        rows={5}
                        placeholder="You can write details about your bulk uniform order, or write about us and how we can improve..."
                        className="w-full flex-1 px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition text-gray-900 placeholder:text-gray-400 resize-none"
                      />
                    </div>
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/70 text-lg mb-10 max-w-2xl mx-auto">
            Our team is available to discuss your uniform requirements and
